...
namespace TSVer3
{
    public partial class GeneralInvoiceList : System.Web.UI.Page
    {
        #region class
        ...
        protected void Btn_Search_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                {
                    dt = new DataTable();
                    dr = obj_admin.Invoice_Search_BillNo3(Convert.ToString(Session["CompanyCode"]), tbx_S_BillNo.Text, "Debit Note");
                    dt.Load(dr);
                    Grd.DataSource = dt;
                    Grd.DataBind();
                }
