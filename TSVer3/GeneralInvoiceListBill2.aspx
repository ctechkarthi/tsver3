<%@ Page Title="Tracksen" Language="C#" MasterPageFile="~/UserSite.Master" AutoEventWireup="true" CodeBehind="GeneralInvoiceListBill2.aspx.cs" Inherits="TSVer3.GeneralInvoiceListBill2" %>
                    ...
                    <asp:TabPanel ID="TabPanel1" runat="server" HeaderText="Invoice List">
                        <ContentTemplate>
                            <table style="width:900px;">
                                <tr>
                                    <td colspan="11" style="text-align: center; font-weight: bold; color: green; font-size: 18px;">Search/Update Invoice with AWB/BL</td>
                                    <tr>
                                        ...
                                        </asp:DropDownList>  </td><td> Enter AWB/BL</td><td>
                            ...
                            <asp:GridView ID="Grd" runat="server" ForeColor="#333333" EmptyDataText="No Record Found."
                                ...
                                <Columns>
                                    ...
                                    <asp:TemplateField HeaderText="Invoice No">
                                        <ItemTemplate>
                                            <a target="_blank" title="Click here to Edit invoice" href="InvoiceNew.aspx?hkh=eorgnveorwmvpe7p0cff4jhgig3nrg&pjl=uietrnfsvhgagdaawdnsgb&ien=<%#Eval("BillNo")%>&fs=IDBI Bank&pqal=cbhgsewjfwfowlhl"><%#Eval("BillNo")%> </a>
                                        </ItemTemplate>
                                    ...
                                    <asp:BoundField DataField="AWBNo" HeaderText="MAWB/MBL">
                                        <HeaderStyle CssClass="TextCenter" Width="80px" />
                                        <ItemStyle CssClass="TextCenter" />
                                    </asp:BoundField>
                                    <asp:BoundField DataField="HAWBNo" HeaderText="HAWB/HBL">
                                        <HeaderStyle CssClass="TextCenter" Width="80px" />
                                        <ItemStyle CssClass="TextCenter" />
                                    </asp:BoundField>
                                    ...
                                    <asp:TemplateField HeaderText="Action">
                                        <ItemTemplate><a target="_blank" href="GeneralInvoice4.aspx?hkh=uoiwnffsdbfkahfseorwmvpe7p0cjhgig3wrwer&kew=iqowpdnsbfvcgfdqwhgd&ien=<%#Eval("BillNo")%>&qwmed=rytvzmdkafyweqljem"><img src="images/Edit.jpg" width="25" height="25" /></a>
                                        </ItemTemplate>
