...
namespace TSVer3
{
    public partial class WebForm1 : System.Web.UI.Page
    {
        ...
        {
            decimal Total = Convert.ToDecimal(123456.87);

            Label1.Text = Total.ToString(); decimal TotAmtRound = Math.Round(Total);

           // Label2.Text = string.Format(String.Format("{0:N2}", TotAmtRound));
            Label2.Text = String.Format("{0:0.00}", TotAmtRound);

            // Label1.Text = "4321";
         //   Label2.Text = rupees_INR(Convert.ToInt64(TextBox1.Text));
            //  decimal IGSTValue_Particulars = Convert.ToDecimal(String.Format("{0: #,#.00}", Convert.ToDecimal(4563.234568)));
            // Label1.Text = IGSTValue_Particulars.ToString();
